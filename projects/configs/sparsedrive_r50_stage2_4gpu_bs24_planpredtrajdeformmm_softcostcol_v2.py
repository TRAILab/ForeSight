    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='ForeSight',
                name='sparsedrive_r50_stage2_4gpu_bs24_planpredtrajdeformmm_softcostcol_v2',),
            interval=50)
    ],
)
load_from = None
...
model = dict(
    ...
    head=dict(
        ...
        motion_plan_head=dict(
            ...
            num_det=50,
            num_map=10,
            plan_softcost_collision_enable=True,
            plan_softcost_collision_weight=0.05,
            plan_softcost_collision_sigma=2.0,
            plan_softcost_geometry='sdf_corners',
