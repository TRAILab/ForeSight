# ================ base config ===================
# Option 1: joint stage-1 with stop-gradient between det/map and motion/plan.
# Det + map train normally; their outputs are detached before being passed to
# motion/planning so gradients from motion/plan never flow back into perception.
version = 'mini'
version = 'trainval'
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='ForeSight',
                name='sparsedrive_r50_stage1_8gpu_noflash_joint_detach',),
            interval=50)
    ],
)
load_from = None
...
task_config = dict(
    ...
    detach_det=True,  # stop-gradient: det/map outputs detached before motion/plan
)
