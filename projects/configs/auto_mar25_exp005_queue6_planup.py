...
# === autoresearch overrides (auto_mar25_exp005_queue6_planup) ===
log_config['hooks'][1]['init_kwargs']['name'] = 'auto_mar25_exp005_queue6_planup'
# Combine exp003 (queue=6, best L2) with exp001 (plan_loss_reg=2, marginal L2+col gain)
# Hypothesis: more temporal context + stronger planning supervision = best of both
queue_length = 6
