from sparsedrive_r50_stage1_8gpu_noflash_nomap import *


log_config["hooks"][1]["init_kwargs"]["name"] = (
    "sparsedrive_r50_stage1_8gpu_noflash_nomap_aux2d"
)
...
adaptor_idx = next(
    idx for idx, step in enumerate(train_pipeline) if step["type"] == "NuScenesSparse4DAdaptor"
)
