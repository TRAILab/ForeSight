...
# === autoresearch overrides (auto_mar25_exp004_decoder8) ===
log_config['hooks'][1]['init_kwargs']['name'] = 'auto_mar25_exp004_decoder8'
# Increase detection decoder depth from 6 to 8 layers
# Richer instance features should improve both detection and downstream motion/planning
num_decoder = 8