    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='ForeSight',
                name='sparsedrive_r50_stage2_4gpu_bs24_planpredtrajdeformmm_planinstfeat_laststage_nodetmap_decoder6_planwp_evalmatchmode_egostatus_minS2_B1p8',),
            interval=50)
    ],
)
load_from = None
...
model = dict(
    ...
    head=dict(
        ...
        motion_plan_head=dict(
            ...
            # B1.8: union of B1.6 (top-K nearest fixed init anchors) + B1.7
            # (plan trajectory waypoints). Per-mode K = K_topk + T_ego_fut = 20 + 6 = 26.
            # Richer keypoint set than either parent, no detection forward pass.
            conflict_input='image_at_init_topk_and_plan',
