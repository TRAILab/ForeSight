    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='Anon',
                name='sparsedrive_r50_stage2_4gpu_bs24_planpredtrajdeformmm_planinstfeat_laststage_nodetmap_decoder6_planwp_evalmatchmode_s2nomotionloss',),
            interval=50)
    ],
)
load_from = None
    ...
    head=dict(
        ...
        motion_plan_head=dict(
            ...
            motion_loss_cls=dict(
                ...
                gamma=2.0,
                alpha=0.25,
                loss_weight=0.0,  # s2nomotionloss: drop motion supervision at stage 2
            ),
            motion_loss_reg=dict(type='L1Loss', loss_weight=0.0),  # s2nomotionloss
