...
# === autoresearch overrides (auto_mar25_exp005_queue6_dec8) ===
log_config['hooks'][1]['init_kwargs']['name'] = 'auto_mar25_exp005_queue6_dec8'
# Combine exp003 (queue=6, best L2=0.5757) + exp004 (decoder=8, best col=0.074%)
# Hypothesis: more temporal context + richer instance features = improvements on both metrics
queue_length = 6
