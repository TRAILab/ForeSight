    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='Anon',
                name='sparsedrive_r50_stage2_4gpu_bs24_ptaux2d_ppdeformmm_planifls_shapeanchor_endptnorm_mag_egostatus',),
            interval=50)
    ],
)
load_from = None
...
model = dict(
    ...
    head=dict(
        ...
        motion_plan_head=dict(
            ...
            plan_anchor='data/kmeans/kmeans_plan_shape_endptnorm.npy',
            plan_anchor_norm_mode='endptnorm',
            plan_anchor_refmag='data/kmeans/kmeans_plan_shape_endptnorm_refmag.npy',
            plan_magnitude_head_enable=True,
