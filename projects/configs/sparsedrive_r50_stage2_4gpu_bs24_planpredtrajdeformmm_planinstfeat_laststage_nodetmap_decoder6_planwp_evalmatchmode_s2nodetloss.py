    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='ForeSight',
                name='sparsedrive_r50_stage2_4gpu_bs24_planpredtrajdeformmm_planinstfeat_laststage_nodetmap_decoder6_planwp_evalmatchmode_s2nodetloss',),
            interval=50)
    ],
)
load_from = None
    ...
    head=dict(
        ...
        det_head=dict(
            ...
            loss_cls=dict(
                ...
                gamma=2.0,
                alpha=0.25,
                loss_weight=0.0,  # s2nodetloss: drop det supervision at stage 2
            ),
            loss_reg=dict(
                type="SparseBox3DLoss",
                loss_box=dict(type="L1Loss", loss_weight=0.0),  # s2nodetloss
                loss_centerness=dict(type="CrossEntropyLoss", use_sigmoid=True, loss_weight=0.0),  # s2nodetloss
                loss_yawness=dict(type="GaussianFocalLoss", loss_weight=0.0),  # s2nodetloss
