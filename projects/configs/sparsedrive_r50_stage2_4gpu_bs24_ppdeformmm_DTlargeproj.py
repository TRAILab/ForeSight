    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='Anon',
                name='sparsedrive_r50_stage2_4gpu_bs24_ppdeformmm_DTlargeproj',),
            interval=50)
    ],
)
load_from = None
...
model = dict(
    ...
    head=dict(
        ...
        motion_plan_head=dict(
            ...
            embed_dims=motion_embed_dims,
            input_embed_dims=embed_dims,
            use_planning_input_proj=True,
            ...
            temp_graph_model=dict(
                ...
                embed_dims=motion_embed_dims if not decouple_attn_motion else motion_embed_dims * 2,
            ...
            norm_layer=dict(type="LN", normalized_shape=motion_embed_dims),
            ffn=dict(
                type="AsymmetricFFN",
                in_channels=motion_embed_dims,
                pre_norm=dict(type="LN"),
                embed_dims=motion_embed_dims,
                feedforward_channels=motion_embed_dims * 2,
                num_fcs=2,
                ffn_drop=drop_out,
                act_cfg=dict(type="ReLU", inplace=True),
            ),
