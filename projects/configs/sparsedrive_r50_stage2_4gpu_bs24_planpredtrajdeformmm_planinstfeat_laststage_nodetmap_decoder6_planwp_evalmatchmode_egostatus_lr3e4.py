    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='ForeSight',
                name='sparsedrive_r50_stage2_4gpu_bs24_planpredtrajdeformmm_planinstfeat_laststage_nodetmap_decoder6_planwp_evalmatchmode_egostatus_lr3e4',),
            interval=50)
    ],
)
load_from = None
...
optimizer = dict(
    type="AdamW",
    lr=3e-4,  # LR sweep: does the headline architecture prefer 3e-4?
    weight_decay=0.001,
    paramwise_cfg=dict(
        custom_keys={
