    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='Anon',
                name='sparsedrive_r50_stage2_4gpu_bs24_planpredtrajdeformmm_planinstfeat_laststage_nodetmap_decoder6_planwp_evalmatchmode_egostatus_minS2_B1p9',),
            interval=50)
    ],
)
load_from = None
...
model = dict(
    ...
    head=dict(
        ...
        motion_plan_head=dict(
            ...
            # B1.9: ego-anchored fixed BEV grid (5x5 = 25 points: forward
            # x={0,6,12,18,24} m, lateral y={-8,-4,0,4,8} m). Shared across
            # plan modes (global pool); no detection forward pass needed.
            conflict_input='image_at_ego_grid',
