    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='ForeSight',
                name='sparsedrive_r50_stage2_4gpu_bs24_predonly_modesk1_kitchen',),
            interval=50)
    ],
)
load_from = None
...
model = dict(
    ...
    head=dict(
        ...
        instance_feature_init="class_embed",
        det_head=dict(
            type="Sparse4DHead",
            ...
            instance_bank=dict(
                ...
                num_temp_instances=134 if temporal else -1,
        ...
        motion_plan_head=dict(
            ...
            # fut_mode=1: single-mode regressor; mode classification is
            # degenerate (only one mode). Zero the cls loss so the mode
            # classifier contributes nothing and top-1 = mode 0 trivially.
            ...
            motion_deformable_waypoints=[1, 3, 5, 7, 11],
            motion_target_in_agent_frame=True,
        ),
    ),
)
