    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='ForeSight',
                name='sparsedrive_r50_stage2_4gpu_bs24_planpredtrajdeformmm_planinstfeat_laststage_nodetmap_decoder6_planwp_evalmatchmode_minS2_nodeform',),
            interval=50)
    ],
)
load_from = None
...
model = dict(
    ...
    head=dict(
        ...
        motion_plan_head=dict(
            ...
            plan_ego_status_encode_enable=False,  # Ablation 3: no ego-status input
            ...
            operation_order=(
                [
                    ...
                    "cross_gnn",
                    "norm",
                    # Ablation 5: planner->image deformable readout removed.
                    "ffn",
                    "norm",
                    "refine",
                ] * 6
            ...
            planning_deformable=False,  # Ablation 5
            planning_deformable_instfeat=False,  # Ablation 5
            planning_deformable_instfeat_laststage=False,  # Ablation 5
            motion_deformable_multimode=False,  # Ablation 5
