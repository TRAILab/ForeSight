    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='ForeSight',
                name='sparsedrive_r50_stage2_4gpu_bs24_ptnomap_decoder6_planwp_evalmatchmode',),
            interval=50)
    ],
)
load_from = None
...
# ================== pretrained model ========================
# ReDrive-Det: stage-1 with 3D detection ONLY (no map head, no 2D aux).
# apollo 8gpu_noflash_nomap/iter_43900.pth - full 100 epochs at batch 64,
# same recipe as the default checkpoint, so det-vs-det+map is single-flag.
load_from = 'ckpt/sparsedrive_stage1_nomap.pth'
