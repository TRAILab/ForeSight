    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='ForeSight',
                name='sparsedrive_r50_stage2_4gpu_nomap_queue6',),
            interval=50)
    ],
)
load_from = None
...
ego_fut_ts = 6
ego_fut_mode = 6
queue_length = 6 # history + current
...
# === autoresearch overrides (auto_mar26_exp004_conf_decay08) ===
log_config['hooks'][1]['init_kwargs']['name'] = 'auto_mar26_exp004_conf_decay08'
