    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='ForeSight',
                name='sparsedrive_r50_stage2_4gpu_bs24_planpredtrajdeformmm_planinstfeat_laststage_nodetmap_decoder6_planwp_evalmatchmode_noS1',),
            interval=50)
    ],
)
load_from = None
...
# ================== pretrained model ========================
# ReDrive-noAux: NO stage-1 pretraining. Backbone starts from the ImageNet
# ResNet-50 (img_backbone.pretrained) exactly as stage 1 itself does; the
# det/map/motion heads are randomly initialised and get only the 10 stage-2
# epochs. Isolates what stage-1 perception supervision is worth in total.
load_from = None
