    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='Anon',
                name='sparsedrive_r50_stage2_4gpu_bs24_ptaux2d_ppdeformmm_planifls_planaux_conf_anchorlabel',),
            interval=50)
    ],
)
load_from = None
...
model = dict(
    ...
    head=dict(
        ...
        motion_plan_head=dict(
            ...
            num_map=10,
            with_conflict_head=True,
            conflict_loss_weight=0.05,
            conflict_threshold=2.0,
            conflict_pos_weight=10.0,
            conflict_label_source='anchor',
        ),
    ),
)
