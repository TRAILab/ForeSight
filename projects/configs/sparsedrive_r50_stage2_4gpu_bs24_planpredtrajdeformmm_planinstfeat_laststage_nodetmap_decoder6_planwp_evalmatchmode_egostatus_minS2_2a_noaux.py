    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='ForeSight',
                name='sparsedrive_r50_stage2_4gpu_bs24_planpredtrajdeformmm_planinstfeat_laststage_nodetmap_decoder6_planwp_evalmatchmode_egostatus_minS2_2a_noaux',),
            interval=50)
    ],
)
load_from = None
...
model = dict(
    ...
    head=dict(
        ...
        motion_plan_head=dict(
            ...
            # 2a-noaux: SceneQueryDecoder produces K=50 image-feature-refined
            # BEV anchors trained end-to-end via conflict BCE only (no aux loss).
            # Init from kmeans of ego-interacting agents (within 20m of ego in
            # next 3s on the train split).
