    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='ForeSight',
                name='sparsedrive_r50_stage2_4gpu_bs24_ptnodetaux2d_decoder6_planwp_evalmatchmode',),
            interval=50)
    ],
)
load_from = None
...
# ================== pretrained model ========================
# Stage-1 with NO detection head (map + aux2d depth only).
# NOTE: epoch 80 of 100 (iter_93760) — the run hit Tamia's 24h cap at
# iter 110109/117200. Also the 4-GPU/bs24 stage-1 recipe (effective
# batch 24) vs the default checkpoint's upstream batch 64.
load_from = 'ckpt/sparsedrive_stage1_nodet_aux2d.pth'
