    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='ForeSight',
                name='sparsedrive_r50_stage2_4gpu_bs24_planpredtrajdeformmm_planinstfeat_laststage_nodetmap_decoder6_planwp_evalmatchmode_s2nomaploss',),
            interval=50)
    ],
)
load_from = None
    ...
    head=dict(
        ...
        map_head=dict(
            ...
            loss_cls=dict(
                ...
                gamma=2.0,
                alpha=0.25,
                loss_weight=0.0,  # s2nomaploss: drop map supervision at stage 2
            ),
            loss_reg=dict(
                type="SparseLineLoss",
                loss_line=dict(
                    type='LinesL1Loss',
                    loss_weight=0.0,  # s2nomaploss
                    beta=0.01,
                ),
                num_sample=num_sample,
                roi_size=roi_size,
