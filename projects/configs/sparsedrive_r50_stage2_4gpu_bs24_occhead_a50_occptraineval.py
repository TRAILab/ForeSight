...
# alpha=0.5: equal per-example weight; visible dominates by count (5.52:1) so
# occluded is under-weighted — tests whether reducing from 0.85 avoids all-occluded collapse.
