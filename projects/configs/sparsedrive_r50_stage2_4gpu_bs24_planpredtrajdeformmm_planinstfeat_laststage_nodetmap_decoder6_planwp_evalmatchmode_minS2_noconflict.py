    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='ForeSight',
                name='sparsedrive_r50_stage2_4gpu_bs24_planpredtrajdeformmm_planinstfeat_laststage_nodetmap_decoder6_planwp_evalmatchmode_minS2_noconflict',),
            interval=50)
    ],
)
load_from = None
    ...
    head=dict(
        ...
        motion_plan_head=dict(
            ...
            refine_layer=dict(
                ...
                ego_fut_ts=ego_fut_ts,
                ego_fut_mode=ego_fut_mode,
                with_conflict_head=False,  # Ablation 4b
            ),
            motion_sampler=dict(
                type="MotionTarget",
            ),
            ...
            planning_decoder=dict(
                ...
                ego_fut_mode=ego_fut_mode,
                use_rescore=False,
                use_rescore_learned_hard=False,  # Ablation 4b: no rescore at all
