    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='Anon',
                name='sparsedrive_r50_stage2_4gpu_bs24_occhead_occptraineval',),
            interval=50)
    ],
)
load_from = None
...
# alpha=0.2: visible gets 0.8 per-example weight; with 5.52:1 imbalance total visible
# pressure = 5.52*0.8=4.4 vs occluded = 1*0.2=0.2 — tests whether over-weighting
# visible avoids all-occluded collapse seen at alpha=0.5 and 0.85.
...
model['head']['det_head']['refine_layer']['with_visibility_estimation'] = True
model['head']['det_head']['loss_visibility'] = dict(
    type='FocalLoss',
    use_sigmoid=True,
    gamma=2.0,
    alpha=0.20,
...
train_pipeline[-1]['keys'].append('gt_occluded')
