...
# alpha=0.70: moderate minority boost; sits between balanced (0.85) and equal-weight
# (0.50) — tests whether a lighter upweight avoids all-occluded collapse while still
# correcting the 5.52:1 class imbalance.
