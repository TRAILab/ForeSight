    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='ForeSight',
                name='sparsedrive_r50_stage2_4gpu_bs24_predonly_classw2x',),
            interval=50)
    ],
)
load_from = None
...
model = dict(
    ...
    head=dict(
        ...
        motion_plan_head=dict(
            ...
            # 2x mode-classification loss (was 0.2). Targets top-1 metric
            # by pushing the mode classifier to converge harder vs the
            # multimodal regression loss (kept at 0.2).
