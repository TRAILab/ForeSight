    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='ForeSight',
                name='sparsedrive_r50_stage2_4gpu_bs24_planpredtrajdeformmm_planinstfeat_laststage_nodetmap_decoder6_planwp_evalmatchmode_egostatus_minS2_bblr0p05',),
            interval=50)
    ],
)
load_from = None
...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            ...
            "img_backbone": dict(lr_mult=0.05),  # Ablation 2c: lr_mult sweep
