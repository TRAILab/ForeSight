    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
            init_kwargs=dict(
                entity='trailab',
                project='ForeSight',
                name='sparsedrive_r50_stage2_4gpu_bs24_ptaux2d_ppdeformmm_planifls_planaux_conf_evalmatch_t85_topk3',),
            interval=50)
    ],
)
load_from = None
    ...
    head=dict(
        ...
        motion_plan_head=dict(
            ...
            planning_decoder=dict(
                ...
                rescore_learned_hard_prob_thresh=0.85,
                rescore_learned_hard_aggregation='topk',
                rescore_learned_hard_topk_k=3,
            ),
            ...
            conflict_pos_weight='auto',
            conflict_label_source='evalmatch',
        ),
    ),
)
