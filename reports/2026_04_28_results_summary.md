...
- **Cross-cluster confirmation of headline + Stream C: L2 reproduces; egostatus CR is *noisy* on Fir/Rorqual and *systematically elevated* on Tamia (two distinct phenomena).** Fir `_egostatus` seed-3 (38335844): L2=0.3701/CR=0.087%. **Fir `_egostatus` (38378856, 2026-05-03 PM): L2=0.3776/CR=0.048%** — second Fir seed lands canonical, ΔCR vs 38335844 = 0.039 pp ≈ 2.5× noise floor. Two Fir reads now span 0.048%–0.087%; mean 0.068% on small N. Rorqual `_egostatus` (11262873): L2=0.3781/CR=0.094%. Rorqual `_egostatus` (11262822): L2=0.3638/CR=0.119%. Tamia `_egostatus` (272454, prior 270279): L2=0.3740/CR=0.243% — *deterministic* (exactly reproduces). Fir `_streamc` (38335845): L2=0.3700/CR=0.040%. Rorqual `_streamc` (11262874): L2=0.3727/CR=0.040%. **Killarney `_streamc` seed-2 train+eval (3400093): L2=0.3669/CR=0.042%**. **Streamc still reproduces cleanly across clusters and seeds** (mean 0.3673/0.037%). **Egostatus revised reading: H100 CR is high-variance (Fir, Rorqual) and Tamia has a separate systematic offset.** Diagnostic in flight on Fir: 38503552 (TF32 off, Fir-ckpt) + 38504768 (K-ckpt, default TF32). Multi-seed reads required to resolve. Killarney L40S remains the canonical CR comparator for egostatus pending the diagnostic. See `reports/2026_05_03_h100_reproduce.md`.
