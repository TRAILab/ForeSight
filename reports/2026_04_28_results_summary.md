...
| Loss zeroing (Stream A, **combined**) | stage-2 perception supervision (joint) | Training completed; eval crashed (3397345) | needs eval-only rerun |
...
- **Cross-cluster confirmation of headline + Stream C (Fir 38335844/45, Rorqual 11262873/74): L2 reproduces; CR is cluster-dependent.** Fir `_egostatus` seed-3 (38335844): L2=0.3701 / CR=0.087%. Fir `_streamc` seed-3 (38335845): L2=0.3700 / CR=0.040%. Rorqual `_egostatus` seed-3 (11262873): L2=0.3781 / CR=0.094%. Rorqual `_streamc` seed-3 (11262874): L2=0.3727 / CR=0.040%. **Streamc reproduces cleanly across clusters** (Killarney 0.3597/0.026%, Fir 0.3700/0.040%, Rorqual 0.3727/0.040% — all within noise of headline). **Egostatus L2 reproduces but CR is elevated** on Fir + Rorqual — Rorqual is known to be missing `95db051` (dtype fix). Tamia seed-3 trains crashed early (272451/272452 at ~1h elapsed) — needs follow-up.
